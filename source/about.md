...
　　但是入职以后，发现这公司存在一个很大的问题：整个研发部包括部长基本不懂网站开发相关的技术。
...
　　在了解到了这个情况以后，我们就试图开始在团队中推广使用 PHP。结果是显而易见的，被固执的部长给否掉了。据我们推测认为，如果换了开发语言重新开始，那么他一年来苦心维持的这个状态将会被打破，他没法向他的上级交代他这一年到底干了什么。并且，影响他在团队中的话语权。
　　其实我一开始被要求学习 React，虽然我一直都是干的后端的活儿——当然 React 也是 Bernard 推荐使用的，部长并没有判断哪种技术适合他们团队的技术水平。
　　
